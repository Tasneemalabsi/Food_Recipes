  ...
  <ul style={{display:"flex"}}>
    {localCollections?localCollections.map(collection=>{
      return(
        ...
        <img src ="https://static.vecteezy.com/system/resources/previews/000/439/792/original/vector-folder-icon.jpg" width={200} height={200} onClick={()=>showItems(collection.collectionName)}/>
